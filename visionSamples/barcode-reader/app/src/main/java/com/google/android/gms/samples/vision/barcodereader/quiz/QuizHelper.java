...
public class QuizHelper extends SQLiteOpenHelper {
    ...
    private void addQuestion() {
        ...
        this.addQuestion(new Question.QuestionBuilder()
                .setQUESTION("1. When was Wat-Umong built?")
                .setOPTA("Over 700 years ago")
                .setOPTB("Over 600 years ago")
                .setOPTC("Over 5000 years ago")
                .setOPTD("Over 10000 years ago")
                .setANSWER("Over 700 years ago")
                .build());
        this.addQuestion(new Question.QuestionBuilder()
                .setQUESTION("2. Which tunnel does not have any evidence of painting on the wall?")
                .setOPTA("Tunnel number 1")
                .setOPTB("Tunnel number 2")
                .setOPTC("Tunnel number 3")
                .setOPTD("Tunnel number 4")
                .setANSWER("Tunnel number 4")
                .build());
        this.addQuestion(new Question.QuestionBuilder()
                .setQUESTION("3. What is the purpose for building Wat-Umong tunnels?")
                .setOPTA("For sleeping")
                .setOPTB("For relaxing")
                .setOPTC("For meditation")
                .setOPTD("For walking")
                .setANSWER("For meditation")
                .build());
        this.addQuestion(new Question.QuestionBuilder()
                .setQUESTION("4. Where is Wat-Umong located?")
                .setOPTA("Bangkok")
                .setOPTB("Chon Buri")
                .setOPTC("Sisaket")
                .setOPTD("Chiangmai")
                ...
                .build());
        this.addQuestion(new Question.QuestionBuilder()
                .setQUESTION("5. The painting on the walls is influenced by which country?")
                .setOPTA("China")
                .setOPTB("England")
                .setOPTC("USA")
                .setOPTD("French")
